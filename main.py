...
@app.get('/get_data')
async def get_data():
    source_url = 'https://github.com/SofiaLimorenko/rick_sanchez/tree/master/android'
    ...
    if response.status_code == 200:
        ...
        destination_url = 'https://github.com/SofiaLimorenko/rick_sanchez/tree/master/ml'
        payload = {
